...
Long Prep é um protótipo de jogo em desenvolvimento focado em um sistema de inventário físico, inspirado em jogos como Resident Evil e Cairn, onde os itens possuem peso, colisão e comportamento 

físico dentro da mochila.
