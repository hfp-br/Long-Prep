...
RPG::Weapon espadacurtaUCweapon("Espada Curta Reforçada", 0.4f, 2, true, false, 8, 3, sword, 0.95f, uncommon);
...
RPG::Weapon espadamediaweapon("Espada Media", 0.5f, 3, true, false, 12, 5, sword, 0.85f, rare);
...
RPG::Weapon espadamediaEPweapon("Espada Media Encantada", 0.55f, 3, true, false, 17, 5, sword, 0.8f, epic);
...
RPG::Weapon espadalongaweapon("Espada Longa", 0.9f, 4, true, false, 22, 7, sword, 0.7f, legendary);
...
// ===== FACAS =====
RPG::Weapon facapequenaweapon("Faca Pequena", 0.6f, 1, true, false, 3, 2, sword, 0.5f, common);
...
RPG::Weapon facapequenaUCweapon("Faca Afiada", 0.6f, 1, true, false, 3, 2, sword, 0.5f, uncommon);
...
RPG::Weapon facarararweapon("Faca Serrilhada", 0.7f, 2, true, false, 8, 3, sword, 0.4f, rare);
...
RPG::Weapon facaEPweapon("Faca Envenenada", 0.75f, 2, true, false, 13, 3, sword, 0.35f, epic);
...
RPG::Weapon facalendweapon("Faca Sombria", 1, 2, true, false, 18, 4, sword, 0.3f, legendary);
...
// ===== ARCOS =====
RPG::Weapon arcopequweapon("Arco Simples", 0.4f, 3, true, false, 6, 15, bow, 1.2f, common);
...
RPG::Weapon arcopequUCweapon("Arco Reforçado", 0.45f, 3, true, false, 9, 16, bow, 1.1f, uncommon);
...
RPG::Weapon arcorarweapon("Arco Élfico", 0.5f, 4, true, false, 14, 20, bow, 1.0f, rare);
...
RPG::Weapon arcoEPweapon("Arco das Sombras", 0.55f, 4, true, false, 20, 22, bow, 0.9f, epic);
...
RPG::Weapon arcolendweapon("Arco Dracônico", 0.7f, 5, true, false, 28, 25, bow, 0.8f, legendary);
...
RPG::Armor capacetelegendArmor("Elmo do Dragão", 2.0f, 4, true, false, 25, legendary);
...
RPG::Armor cotelegendArmor("Armadura do Caos", 3.0f, 5, true, false, 45, legendary);
...
RPG::Armor cintolendArmor("Cinto da Morte", 1.0f, 3, true, false, 10, legendary);
...
RPG::Armor botaslegendArmor("Botas do Vento", 1.5f, 4, true, false, 20, legendary);
...
// ===== ACESSÓRIOS =====
RPG::Armor anelocomumArmor("Anel de Bronze", 0.4f, 1, true, false, 1, common);
...
RPG::Armor aneloUCArmor("Anel de Prata", 0.4f, 1, true, false, 2, uncommon);
...
RPG::Armor anelorareArmor("Anel de Safira", 0.4f, 1, true, false, 4, rare);
...
RPG::Armor aneloEPArmor("Anel de Rubi", 0.4f, 1, true, false, 7, epic);
...
RPG::Armor anelolendArmor("Anel do Abismo", 0.4f, 1, true, false, 10, legendary);
...
// ===== INGREDIENTES =====
RPG::Ingredient ingredientBaseIng(5,"Base de pocao",0.2,1,false,true);
...
RPG::Ingredient ingredienteDanoIng(0,"Lodo da morte",0.4,1,false,true);
...
RPG::Ingredient ingredienteVidaIng(1,"Ervas de menta",0.4,1,false,true);
...
RPG::Ingredient ingredienteSpeedIng(2,"Pena de Aguia",0.4,1,false,true);
...
RPG::Ingredient ingredienteLuckIng(3,"Trevo 4 folhas",0.4,1,false,true);
...
RPG::Ingredient ingredienteMultIng(4,"Estrela do Alem",0.4,1,false,true);
...
// ===== POCOES =====
RPG::Potion_Damage pocaoDanoPoc("Base de pocao",0.2,1);
...
RPG::Potion_Health pocaoVidaPoc("Base de pocao",0.2,1);
...
RPG::Potion_Speed pocaoSpeedPoc("Base de pocao",0.2,1);
...
RPG::Potion_Luck pocaoLuckPoc("Base de pocao",0.2,1);
...
RPG::Potion_Mult pocaoMultPoc("Base de pocao",0.2,1);
